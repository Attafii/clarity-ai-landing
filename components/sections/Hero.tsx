...
const techLogos = [
  {
    node: <SiGithub className='text-gray-600 dark:text-gray-400' />,
    title: 'GitHub',
  ...
  {
    node: <SiNotion className='text-gray-600 dark:text-gray-400' />,
    title: 'Notion',
    href: 'https://notion.so',
  },
  {
    node: <SiLinear className='text-gray-600 dark:text-gray-400' />,
    title: 'Linear',
    href: 'https://linear.app',
  },
  {
    node: <SiSlack className='text-gray-600 dark:text-gray-400' />,
    title: 'Slack',
...
const techLogosRow2 = [
  {
    node: <SiFigma className='text-gray-600 dark:text-gray-400' />,
    title: 'Figma',
    href: 'https://figma.com',
  },
  {
    node: <SiDiscord className='text-gray-600 dark:text-gray-400' />,
    title: 'Discord',
    href: 'https://discord.com',
  },
  {
    node: <SiSupabase className='text-gray-600 dark:text-gray-400' />,
    title: 'Supabase',
    href: 'https://supabase.com',
  },
  {
    node: <SiNetflix className='text-gray-600 dark:text-gray-400' />,
    title: 'Netflix',
    href: 'https://netflix.com',
  },
  {
    node: <SiSpotify className='text-gray-600 dark:text-gray-400' />,
    title: 'Spotify',
    href: 'https://spotify.com',
  },
  {
    node: <SiTailwindcss className='text-gray-600 dark:text-gray-400' />,
    title: 'Tailwind CSS',
    href: 'https://tailwindcss.com',
  },
  {
    node: <SiTypescript className='text-gray-600 dark:text-gray-400' />,
    title: 'TypeScript',
